...
c1 = net.addKubeCluster("test", '172.16.3.0', '172.16.3.255', config = "config/kind.yaml")
info('*** Adding docker container 1\n')
k1 = c1.addKubeNode("test", "k1", role = "control-plane", type = "kind", system_reserved_cpu = "1")
info('*** Adding docker container 2\n')
k2 = c1.addKubeNode("test", "k2", role = "worker", type = "kind")
info('*** finished\n')
